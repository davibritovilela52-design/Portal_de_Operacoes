...
import { fetchAviationAgendaSnapshot } from '../../../../lib/portal-api';
import {
...
import { AviationAgendaAssetFilterForm } from './aviation-agenda-asset-filter-form';
...
const AGENDA_BASE_PATH = '/aviation/agenda';
...
type AviationAgendaPageProps = {
  searchParams?: Promise<Record<string, string | string[] | undefined>>;
};

export default async function AviationAgendaPage({ searchParams }: AviationAgendaPageProps) {
  const session = await requirePortalSession();
  const [{ agendaEvents, fleetAssets }, resolvedSearchParams] = await Promise.all([
    fetchAviationAgendaSnapshot({
                ...
                {canChooseCreateAsset ? (
                  ...
                  <div className="form-field form-field--full">
                    ...
                    <div className="form-value">
                      {defaultCreateAsset ? defaultCreateAsset.name : 'Aeronave não informada'}
                    </div>
                  </div>
                )}
            ...
            {isConfirmingDelete ? (
              <div className="modal-inline-confirmation" role="dialog" aria-modal="true">
                <div className="modal-inline-confirmation__card">
                  ...
                  <p>Essa ação remove o evento do calendário da aeronave selecionada.</p>
                  <div className="form-actions">
                    <Link
                      className="action-button action-button--ghost"
                      href={buildAgendaViewHref(monthCursor, {
