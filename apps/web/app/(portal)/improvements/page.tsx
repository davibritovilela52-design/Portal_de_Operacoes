...
type ImprovementsPageProps = {
  searchParams?: Promise<Record<string, string | string[] | undefined>>;
};

export default async function ImprovementsPage({ searchParams }: ImprovementsPageProps) {
  ...
  const mode = readImprovementsMode(resolvedSearchParams);
  const filterQuery = readMaintenanceTicketFilterQuery(resolvedSearchParams);
  const selectedTicketId = readSelectedImprovementTicketId(resolvedSearchParams);
  ...
  const improvementsListPath = buildMaintenanceTicketPath('/improvements', filterQuery);
  const improvementsCreatePath = buildMaintenanceTicketPath('/improvements', filterQuery, {
    mode: 'create'
  });
  ...
  const improvementDetailPath = selectedTicketSummary
    ? buildMaintenanceTicketPath('/improvements', filterQuery, {
        ticketId: selectedTicketSummary.id
      })
    : improvementsListPath;
  ...
  return (
    <div className="page">
      <PageHeader
        title="Melhorias"
        actions={
          <Link className="action-button" href={improvementsCreatePath}>
            Abrir nova melhoria
          </Link>
        }
      />
      ...
      <Panel>
        <MaintenanceTicketFilterForm action="/improvements" query={filterQuery} />
      </Panel>

      <Panel>
        <MaintenanceKanbanBoard columns={kanbanColumns} returnTo={improvementsListPath} />
      </Panel>
          ...
          <div className="modal-card">
            ...
            <div className="maintenance-ticket-modal">
              ...
              <TicketWorkflowActionButtons
                ...
                returnTo={improvementDetailPath}
                ticketId={selectedTicketSummary.id}
              />
              ...
              <div className="form-actions form-actions--end">
                <Link className="action-button action-button--ghost" href={improvementsListPath}>
                  Fechar
                </Link>
              </div>
            </div>
        ...
        <div className="modal-backdrop">
          <div className="modal-card">
            ...
            <form action={createMaintenanceTicketAction} className="action-form">
              ...
              <input name="returnTo" type="hidden" value={improvementsListPath} />
              ...
              <div className="form-grid">
                ...
                <label className="form-field">
                  ...
                  <input
                    name="reason"
                    type="text"
                    placeholder="Descreva o motivo da melhoria"
                    required
                  />
                </label>
                ...
                <label className="form-field form-field--full">
                  ...
                  <textarea
                    name="notes"
                    rows={4}
                    placeholder="Adicione detalhes complementares da melhoria."
                  />
                </label>
              </div>
...
function readImprovementsMode(searchParams: Record<string, string | string[] | undefined>) {
  return searchParams.mode === 'create' ? 'create' : null;
}

function readSelectedImprovementTicketId(
  searchParams: Record<string, string | string[] | undefined>
) {
